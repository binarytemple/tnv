...
public class TNVPreferenceDialog extends JFrame {
	...
	private class ColorChooserPanel extends JPanel implements ChangeListener {
		 ...
		 * @param c
		 */
		protected ColorChooserPanel(String t, Color c) {
			this.type = t;
			this.col = c;
		 ...
		 * @param c
		 */
		protected void changeType( String t, Color c ) {
			this.type = t;
			this.col = c;
	...
	private class HostColorBox extends JPanel implements ChangeListener {
		 ...
		 * @param c
		 */
		protected HostColorBox(Color c) {
			this.col = c;
		}
	 ...
	 * @throws HeadlessException
	 */
	protected static TNVPreferenceDialog createTNVPreferenceDialog() throws HeadlessException {
