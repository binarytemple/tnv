...
public class TNVErrorDialog extends JDialog {
	 ...
	 * @param message
	 */
	protected static void createTNVErrorDialog(String message) throws HeadlessException {
	 ...
	 * @param message
	 */
	protected static void createTNVErrorDialog(Class callingClass, String message) throws HeadlessException {
	 ...
	 * @param ex
	 */
	protected static void createTNVErrorDialog(Class callingClass, String message, Exception ex) throws HeadlessException {
