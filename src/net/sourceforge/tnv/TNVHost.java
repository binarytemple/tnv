...
public abstract class TNVHost extends PNode {
	 ...
	 */
	protected static final String PROPERTY_SELECTED_NODE = "selectedHost";
	 ...
	 * @param select
	 */
	protected abstract void setSelected( boolean select );

	/**
	 * @param select
	 */
	protected abstract void setSelectedLink( boolean select );
	 ...
	 */
	protected InetAddress getIpAddress( ) throws UnknownHostException {
