...
public class TNVLocalHostCell extends PNode {
	 ...
	 */
	protected final boolean hasWidthFocus( ) {
	 ...
	 */
	protected final void setWidthFocus( boolean widthFocus ) {
	 ...
	 */
	protected final void setStartTime( Timestamp t ) {
		this.startTime = t;
	 ...
	 */
	protected final void setEndTime( Timestamp t ) {
		this.endTime = t;
		this.invalidatePaint();
	}
	 ...
	 */
	protected final int getFrequency( ) {
